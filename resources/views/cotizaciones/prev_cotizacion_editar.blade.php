                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" >
                            <label>Empresa:</label>
                            <input type="text" class="form-control" id="cli_empresa" v-model="cli_empresa" name="cli_empresa" placeholder="Nombre de la empresa" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                    <!-- /.form-group -->
                    <div class="form-group">
                        <label>Cliente:</label>
                        <input type="text" class="form-control" id="cliente" v-model="cliente" name="cliente" placeholder="Empresa del cliente" value="" readonly>
                    </div>
                    <!-- /.form-group -->
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="form-group">
                        <label>Puesto:</label>
                        <input type="text" class="form-control" id="cli_puesto" v-model="cli_puesto" name="cli_puesto" placeholder="Puesto del cliente" value="" readonly>
                    </div>
                    </div>
                    <div class="col-md-4">
                    <!-- /.form-group -->
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cli_telefono" v-model="cli_telefono" name="cli_telefono" placeholder="Telefono del cliente" value="" readonly>
                    </div>
                    <!-- /.form-group -->
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Correo:</label>
                            <input type="email" class="form-control" id="cli-email" v-model="cli_email" name="cli-email" placeholder="E-mail del cliente" value="" readonly>
                        </div>
                    </div>
                    <div class="col-md-2">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select v-model="idconcepto" ref="textoselect" name="cot_concepto" id="cot_concepto" class="form-control select2texto" style="width: 100%;">
        ...
        new Vue({
            ...
            methods: {
                insertarDatos() {
                    ...
                    this.cli_puesto = cotizacion.cli_puesto;
                    this.cli_email = cotizacion.cli_correo;
                    this.cli_telefono = cotizacion.cli_telefono;
                    ...
                    detalles.forEach(element => {
                        if(element.tipo == 'PR') {
                            this.productosList.push(element);
                        }
                        else{
                            this.serviciosList.push(element)
                            if (Array.isArray(element.adicionales)) {
                                this.adicionalesList.push(...element.adicionales);
                            } else {
                                this.adicionalesList.push(element.adicionales); // Solo si no es un array
                            }
                        }
                    });
                },
