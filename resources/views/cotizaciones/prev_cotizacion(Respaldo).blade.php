                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" v-show="!reg_nuevo_user">
                            ...
                            <select ref="clienteselect" name="cli_empresa" id="cli_empresa" class="form-control select2cliente" style="width: 100%;">
                                ...
                                <option v-for="cli in clientes" :value="cli.accountname">@{{cli.accountname}}</option>
                            </select>
                        </div>
                        <div class="form-group" v-show="reg_nuevo_user">
                            <label>Empresa:</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            ...
                            <label for="nuevo_usuario" class="form-check-label">El cliente es nuevo? </label>
                        </div>
                    </div>
                </div>
        <!-- /.fin de clientes -->
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="producto-nombre" v-model="currentProducto.nombre" placeholder="nombre del producto" name="pr_nombre" value="">
                                    </div>
                                    </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" v-model="servicios.costo_unidad" placeholder="Precio" name="sr_precio" value="">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                <div class="mb-6">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(producto, index) in productosList" :key="index">
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input" v-model="producto.reg_nuevo_prod" type="checkbox" name="nuevo_prod" id="nuevo_prod">
                                        </div>
                                    </td>
                                    <td>
    ...
    <script>
        new Vue({
            ...
            methods: {
                ...
                selectCliente(){
                    this.cli_empresa = this.$refs.clienteselect.value;
                },
                selectTexto(event){
